    ...
    <div className="pb-20 pt-36">
      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
           ...
           */}
          <TextGenerateEffect
            words="Crafting Interfaces That Speak for Themselves"
            className="text-center text-[40px] md:text-5xl lg:text-6xl -mt-10"
          />

          <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
            Hi! I&apos;m Nasir, a Full Stack Developer based in Bangladesh.
          </p>
          ...
          <div className="flex justify-center items-center gap-3">
            ...
            <Link
              target="_blank"
              href="https://docs.google.com/document/d/1KZt5Ai6sCwHWtRCKDbxe6UYUPgklvx8xGJlBq4ows6M/edit?usp=sharing"
            >
              <MagicButton
                title="Resume"
                icon={<FaLocationArrow />}
